...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_invoice_journal_shop',
    download_url='https://github.com:nantic/trytond-account_invoice_journal_shop.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_invoice_journal_shop.git'
    },
    classifiers=[
